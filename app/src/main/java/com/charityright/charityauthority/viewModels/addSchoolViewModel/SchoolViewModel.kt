...
class SchoolViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private suspend fun getSchoolReportResponse(): SchoolReportBaseModel {
        ...
        val response = AdminRequestInterface().schoolReport("Bearer "+ CustomSharedPref.read("TOKEN",""),id)
    ...
    private suspend fun getSchoolDetailsResponse(): ClassListBaseResponse {
        val response = AdminRequestInterface().schoolDetailsList("Bearer "+ CustomSharedPref.read("TOKEN",""),id)
