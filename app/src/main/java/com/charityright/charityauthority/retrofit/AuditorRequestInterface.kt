...
interface AuditorRequestInterface {
    ...
    @GET("api/next_day_task_list")
    fun upcomingAssignList(@Header("Authorization") token: String): Call<AssignedReportBaseModel>
    ...
    @FormUrlEncoded
    @POST("api/get_site_visit_list_by_form_id")
    fun getReportList(@Header("Authorization") token: String,@Field("status") status: String): Call<AllAuditReportBaseResponse>

    @FormUrlEncoded
    @POST("api/edit_site_visit_form")
    fun getDraftResponse(@Header("Authorization") token: String,@Field("id") id: String): Call<DraftResponse>
    ...
    fun addFieldVisit(
        ...
        @Part("assign_time") assign_time: RequestBody,
        @Part("class_list") class_list: RequestBody
    ): Call<BaseResponse>


    @Multipart
    @POST("api/update_site_visit")
    fun updateFieldVisit(
        @Header("Authorization") token: String,
    ...
    companion object {
        ...
        operator fun invoke(): AuditorRequestInterface {
