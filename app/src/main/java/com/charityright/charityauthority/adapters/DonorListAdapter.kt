...
class DonorListAdapter(
    ...
    override fun onBindViewHolder(holder: DonorListAdapter.ViewHolder, position: Int) {
        ...
        Picasso.get().load("${BaseUrl.URL}${donarList[position]?.image}").placeholder(R.drawable.image_placeholder).error(R.drawable.image_placeholder).into(holder.binding.imageView)
