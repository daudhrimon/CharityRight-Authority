...
class StudentDetailsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        studentDetailsViewModel.studentDetailsResponse.observe(viewLifecycleOwner, Observer{

            if (it?.response_status == "200"){
                Picasso.get().load("${BaseUrl.URL}${it.data?.image_url}").placeholder(R.drawable.image_placeholder).into(binding.imageView)
