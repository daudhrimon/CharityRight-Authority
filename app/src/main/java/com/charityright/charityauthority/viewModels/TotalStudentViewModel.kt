...
class TotalStudentViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private suspend fun getStudentListResponse(): FilteredStudentList {
        ...
        val response = AdminRequestInterface().getFilteredStudentList("Bearer "+ CustomSharedPref.read("TOKEN",""),zone_id,school_id,class_id)
    ...
    private suspend fun getSchoolWiseClassListResponse(): SchoolWiseClassList {
        ...
        val response = AdminRequestInterface().getSchoolWiseClass("Bearer "+ CustomSharedPref.read("TOKEN",""),school_id)
    ...
    private suspend fun getZoneWiseSchoolListResponse(): ZoneWiseSchoolList {
        ...
        val response = AdminRequestInterface().getZoneWiseSchool("Bearer "+ CustomSharedPref.read("TOKEN",""),zone_id)
